...
export default function Header({ parentClassName }) {
  return (
    <header className={parentClassName}>
      ...
      <h1 className="mobile-only">
        <button onClick={() => {
          document.getElementById("mobile-header-content").classList.add("show");
        }}>
          <FontAwesomeIcon icon={faBars} />
        </button>
      </h1>
      <div id="mobile-header-content" className="mobile-only">
        <h1 className="close-mobile-header">
          <button className="dark-blue" onClick={() => {
            document.getElementById("mobile-header-content").classList.remove("show");
          }}>
